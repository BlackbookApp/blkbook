    ...
    <div className="flex-1 flex flex-col items-center justify-center px-6">
      <div className="max-w-[260px] w-full text-center animate-fade-in space-y-8">
        ...
        <div className="space-y-4">
          <p
            className="text-[19px] font-light tracking-[0.01em] uppercase"
            style={{ color: '#0E0E0E', fontFamily: "'GT Super Display', 'Canela Deck', serif" }}
          >
            Your Vault is Ready
          </p>
          <p
            className="text-[13px] leading-[1.6] font-[300]"
            style={{ color: '#0E0E0E', fontFamily: "'Helvetica Neue', 'Helvetica', sans-serif" }}
          >
        ...
        <AddDrawer>
          ...
          >
            ...
            <span className="w-6 h-6 border border-foreground/20 flex items-center justify-center">
              <Plus className="w-3 h-3" style={{ color: '#4A4A4A' }} strokeWidth={2} />
            </span>
